...
const AboutSection = (props) => {
  ...
  const impactStats = [
    {
      number: "50%",
      label: "Reduced Employee Turnover",
      description: "Through structured hiring & retention strategies",
    },
    {
      number: "100%",
      label: "Improved Productivity",
      description: "Via training & process optimization",
    },
    {
      number: "100%",
      label: "Legal Compliance",
      description: "Full adherence to Kerala & Indian labour laws",
    },
    {
      number: "50%",
      label: "Faster Hiring",
      description: "Reduced vacancy impact on business performance",
    },
  ];
  ...
  const whyChooseUs = [
    {
      ...
      description:
        "Understanding Kerala’s business culture while applying proven HR practices from around the world",
    },
    {
    ...
    },
    {
      ...
      description:
        "Tailored solutions designed for small & mid-sized business budgets and goals",
    },
    {
      title: "Proven Track Record",
      description:
        "Decades of business experience translated into actionable HR strategies",
    },
  ];
          ...
          <div className="col-lg-6 col-md-12 col-12">
            <div className="wpo-about-text">
              ...
              <div className="wpo-about-icon-content">
                ...
                >
                  Hire, Manage, Grow - Leading HR Consultancy in Calicut, Kerala
                </h1>
                <p
                  style={{
                    fontSize: "20px",
                ...
                >
                  Leading HR consultancy in Calicut, Kerala, dedicated to
                  helping SMEs across Kerala and India build, grow, and scale
                  with the power of the right people.
                </p>
                <p
                  style={{
                    fontSize: "20px",
                ...
                >
                  Befirst HR & Management Consultancy is a{" "}
                  <strong> leading HR consultancy in Calicut, Kerala, </strong>{" "}
                  dedicated to helping{" "}
                  <strong> SMEs in Kerala and India </strong> build, grow, and
                  scale with the power of the right people.
                </p>
                <p
                  style={{
                    fontSize: "20px",
                ...
                >
                  ...
                  <strongh>
                    {" "}
                    people are the backbone of every successful business.{" "}
                  </strongh>{" "}
                  Our mission is simple — equip growing businesses with
                  world-class{" "}
                  <strong>
                    {" "}
                    HR solutions, recruitment services, training, and compliance
                    support{" "}
                  </strong>{" "}
                  so they can focus on what they do best: running and expanding
                  their business.
                </p>
              </div>
            </div>
          ...
          <div className="col-12">
            ...
            >
              ...
              <div className="row justify-content-center">
                <div className="col-lg-10 mx-auto">
                  ...
                  >
                    ...
                    >
                      The concept of Befirst HR & Management Consultancy was
                      born out of a clear gap in the market: while Kerala is
                      home to thousands of ambitious entrepreneurs and
                      fast-growing SMEs,{" "}
                      <strong style={{ color: "#0062cc" }}>
                        most struggle to find, manage, and retain the right
                        talent.
                      </strong>
                    </p>
                    <p
                    ...
                    >
                      Without the right HR systems, policies, and skilled
                      people, even the most promising businesses hit growth
                      roadblocks. Our goal is to{" "}
                      <strong style={{ color: "#0062cc" }}>
                        bridge that gap
                      </strong>{" "}
                      — bringing{" "}
                      <strong style={{ color: "#0062cc" }}>
                        corporate-grade HR expertise
                      </strong>{" "}
                      to small and medium-sized enterprises at a scale and cost
                      that works for them.
                    </p>
                  </div>
                </div>
              ...
              <div className="text-center" style={{ marginBottom: "40px" }}>
                ...
                >
                  40 Years of Proven Business Expertise
                </h3>
                <div
                  style={{
                    width: "60px",
              ...
              <div className="row justify-content-center">
                <div className="col-lg-10 mx-auto">
                  ...
                  >
                    ...
                    >
                      At the heart of Befirst HRM is{" "}
                      <strong style={{ color: "#0062cc" }}>
                        Mr. Charummal
                      </strong>
                      , whose four decades of experience in business management,
                      operations, and entrepreneurship form the backbone of our
                      approach.
                    </p>
                    <ul style={bulletList}>
                      <li style={bulletItem}>
                        His career spans multiple industries, giving us a
                        360-degree understanding of business challenges.
                      </li>
                      <li style={bulletItem}>
                        His insights help us design HR strategies that don’t
                        just work on paper but deliver measurable results in the
                        real world.
                      </li>
                      <li style={{ ...bulletItem, marginBottom: 0 }}>
                        This legacy ensures we don’t just offer HR services — we
                        offer business growth solutions.
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <div className="row" style={{ marginBottom: "80px" }}>
          <div className="col-12">
            <div className="text-center" style={{ marginBottom: "50px" }}>
              ...
              >
                Our core values define who we are and how we deliver exceptional
        ...
        <div className="row">
          <div className="col-12">
            ...
            >
              ...
              >
                Whether you're a startup in Kozhikode or an established SME in
                Kerala, we'll help you attract, manage, and retain the right
                people so your business can grow faster and scale sustainably.
              </p>
