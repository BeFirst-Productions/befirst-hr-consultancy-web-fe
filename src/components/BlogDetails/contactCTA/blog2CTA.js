            ...
            <div className="text-white">
               <div className="mb-3 mb-md-4">
                <div className="d-flex align-items-center mb-3">
                  <Phone size={28} className="me-3 text-warning" />
                ...
                <p className="mb-0 opacity-90 lh-base" style={{
                  ...
                  to discuss how <span className="text-warning fw-bold">recruitment outsourcing</span> can transform your hiring process.
                </p>
              </div>
