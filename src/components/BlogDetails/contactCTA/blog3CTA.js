...
import { Phone, Mail, Globe, Building2, Users, Briefcase, ArrowRight, Target, TrendingUp, Award, Shield, MapPin } from 'lucide-react';
            ...
            <div className="text-white">
              <div className="mb-3 mb-md-4">
                <div className="d-flex align-items-center mb-3">
                  <div className="bg-gradient-primary rounded-circle p-2 me-3">
                    <Phone size={24} className="text-white phone-pulse" />
                  </div>
                  <div className="badge bg-warning text-dark px-3 py-2 rounded-pill fw-semibold">
                    Trusted Partner
                  </div>
                </div>
                
                <h2 className="mb-3 fw-bold lh-base" style={{
                  color:'white', 
                  fontWeight:'700',
                  fontSize: 'clamp(1.4rem, 4vw, 2.1rem)',
                  lineHeight: '1.3'
                }}>
                  Contact <span className="text-warning">Befirst HR & Management Consultancy</span> today
                </h2>
                
                <div className="d-flex align-items-center mb-3">
                  <MapPin size={20} className="text-warning me-2 flex-shrink-0" />
                  <p className="mb-0 opacity-90" style={{
                    color:'#e2e8f0',
                    fontSize: 'clamp(1.1rem, 2.5vw, 1.3rem)',
                    fontWeight: '500'
                  }}>
                    Your trusted HR partner in <span className="text-warning fw-bold">Calicut</span>
                  </p>
                </div>
              </div>
