...
const WhyChoose6 = () => {
  const reasons = [
    "40+ years of HR and compliance management experience.",
    "End-to-end support for statutory and labour law compliance.",
    "Risk-free operations with proactive compliance monitoring.",
    "Tailored HR audit services for startups, SMEs, and corporates.",
  ];
        ...
        <div className="row mb-5">
          <div className="col-lg-8 mx-auto text-center">
            <h2 className="display-6 fw-bold mb-3 text-dark">
              Why Choose Befirst HR for HR Compliance Services in Kerala?
            </h2>
