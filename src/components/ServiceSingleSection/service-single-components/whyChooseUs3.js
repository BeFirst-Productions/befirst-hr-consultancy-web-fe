...
const WhyChoose3 = () => {
  const reasons = [
    "40+ years of HR and training expertise in Kerala and beyond.",
    "Customized training programs for startups, SMEs, and large organizations.",
    "Focus on leadership, technical, and behavioral skill development.",
    "Proven methods that enhance employee performance and organizational success.",
  ];
        ...
        <div className="row mb-5">
          <div className="col-lg-8 mx-auto text-center">
            <h2 className="display-6 fw-bold mb-3 text-dark">
              Why Choose Befirst HR for L&D Services in Kerala?
            </h2>
