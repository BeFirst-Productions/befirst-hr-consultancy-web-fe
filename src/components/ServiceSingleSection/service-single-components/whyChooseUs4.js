...
const WhyChoose4 = () => {
  const reasons = [
    "40+ years of expertise in HR and payroll management.",
    "Secure and accurate salary processing with complete confidentiality",
    "Compliance-focused solutions aligned with Kerala’s labour and tax laws.",
    "Tailored services for startups, SMEs, and large-scale organizations.",
  ];
        ...
        <div className="row mb-5">
          <div className="col-lg-8 mx-auto text-center">
            <h2 className="display-6 fw-bold mb-3 text-dark">
              Why Choose Befirst HR for Payroll Outsourcing in Kerala?
            </h2>
